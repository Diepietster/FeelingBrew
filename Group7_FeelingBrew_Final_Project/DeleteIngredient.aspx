<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteIngredient.aspx.cs" Inherits="Group7_FeelingBrew_Final_Project.DeleteIngredient" %>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSearch" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="30px" OnClick="btnSearch_Click" Text="Search" Width="141px" CausesValidation="False" />
                            ...
                            <tr>
                                <td class="auto-style26">
                                    <asp:Label ID="lblIngredientEdit" runat="server" Font-Names="Consolas" Text="Select ingredient to delete:"></asp:Label>
                                </td>
                                <td>
