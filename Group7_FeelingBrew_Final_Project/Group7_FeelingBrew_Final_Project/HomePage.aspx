...
&nbsp;&nbsp;
                                <asp:Button ID="btnUpdateClient" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="Update" Width="110px" OnClick="btnUpdateClient_Click" />
&nbsp;&nbsp;
...
&nbsp;&nbsp;
                                <asp:Button ID="btnUpdateSupplier" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="Update" Width="110px" OnClick="btnUpdateSupplier_Click" />
&nbsp;&nbsp;
...
&nbsp;&nbsp;
                                <asp:Button ID="btnUpdateBeer" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="Update" Width="110px" OnClick="btnUpdateBeer_Click" />
&nbsp;&nbsp;
...
&nbsp;&nbsp;
                                <asp:Button ID="btnUpdateIngredient" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="Update" Width="110px" OnClick="btnUpdateIngredient_Click" />
&nbsp;&nbsp;
...
&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnPlacePO" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="Place Order" Width="110px" OnClick="btnPlacePO_Click" />
&nbsp;&nbsp;
                    <asp:Button ID="btnViewPO" runat="server" Font-Names="Consolas" Font-Size="Medium" Height="39px" Text="View Orders" Width="110px" OnClick="btnViewPO_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style19">&nbsp;</td>
